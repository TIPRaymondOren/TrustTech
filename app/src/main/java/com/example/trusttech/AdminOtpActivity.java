...
public class AdminOtpActivity extends AppCompatActivity {
        ...
        verify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(otpPin.getText().toString())) {
                    ...
                    Toast.makeText(AdminOtpActivity.this, "Please enter OTP", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks mCallBack = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
        ...
        public void onVerificationFailed(FirebaseException e) {
            ...
            Toast.makeText(AdminOtpActivity.this, e.getMessage(), Toast.LENGTH_LONG).show();
        }
    };
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(AdminOtpActivity.this, task.getException().getMessage(), Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }
